...
local L = {
	deDE = {
		...
		OPTION_FCT_FADEOUT_TIME = "Ausblendungszeit",
		OPTION_FCT_POSITION = "Position",
		OPTION_FCT_SCALE = "Skalierung",
		OPTION_FCT_SCROLLSPEED = "Scrollgeschwindigkeit",
		...
		OPTION_REPARENT_COMBAT_TEXT = "Kampftext loslösen und ins Weltfenster (WorldFrame) einbetten",
		OPTION_SHOW_NOTINCOMBAT = "Nicht im Kampf",
		OPTION_TRIM_MESSAGE = "Lange Nachrichten unterteilen",
		OPTION_TRIM_REALM_NAME = "Realmnamen kürzen",
		PARTY = "P",
		PARTY_LEADER = "PL",
		RAID = "R",
		RAID_LEADER = "RL",
		SAY = "S",
		USE_CLASS_COLORS = "Bitte benutze dafür das Addon Class Colors",
